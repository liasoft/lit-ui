 ...
 * `disabled`, its `disabledWhen` condition, and `visible: false` (also
 * rendered as a disabled control) all count.
 */
...
function unlimitedMax(field: ExtendedFormField): string | undefined {
  ...
  // The ceiling is derived from the declared `maxlength`: 9 means
  // "999999999". Kept as a string so 16-digit limits
