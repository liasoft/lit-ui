 ...
 * paste and auto-advance and submits itself once the last box is filled — the
 * twig original was a single free-text input, which is still available behind
 * the `simple` flag. Two escape hatches the original lacked are built in: a
