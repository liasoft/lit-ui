 ...
 *
 * The reference implementation squeezed all three states into one `<select>`
 * plus a bare QR image; this element models them as explicit stages, renders
 * the choice as described radio cards, puts the shared secret in a copyable
 * field for people who cannot scan, and adds the recovery-code list the
 * original never produced. It stays presentation-only — bring your own QR data
