 ...
 * ```
 *
 * Pass `inline` for a full-page `alert alert-warning` panel instead of a
 * modal. The code field is segmented by default; `simple` restores the
 * single input.
 *
 * @example
 * ```html
