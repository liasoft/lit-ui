 ...
 *
 * The opt-ins (e.g. "also delete the user's files") are an arbitrary
 * {@link QuestionExtra} list, and the answer row any set of
 * {@link QuestionAnswer}s rather than a fixed Yes/No pair.
 * Answering emits `lia-answer` with both the chosen
