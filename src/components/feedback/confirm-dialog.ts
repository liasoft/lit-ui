...
/**
 * An extra opt-in switch shown inside the dialog — the generic form of
 * Froxlor's "also delete the user's files" checkbox on its delete prompts.
 */
...
/**
 * The "are you sure?" dialog — Froxlor's `form/yesnoquestion.html.twig` as a
 * promise-returning component.
 *
