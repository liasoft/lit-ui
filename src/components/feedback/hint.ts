 ...
 * actions.
 *
 * One component covers every stand-alone diagnostic screen Froxlor ships as a
 * separate template — missing PHP extensions, wrong file ownership, a rate
 * limit, missing vendor files, an unrecoverable database error, the
 * not-yet-installed welcome screen — purely by feeding it different data.
 *
 * @example
 * ```ts
 * html`<lia-hint
