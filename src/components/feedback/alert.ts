...
/**
 * A contextual message — the component behind Froxlor's `misc/alertbox`
...
export class LiaAlert extends LiaElement {
  ...
  /**
   * Monospace detail block under the message, separated by a rule — Froxlor's
   * `alert_info` (stack traces, database debug output).
   */
