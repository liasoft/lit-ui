 ...
 * diffs, credentials and the hierarchical tree.
 *
 * Each one is built as the
 * *interaction pattern* it really is — a record editor is not a DNS zone
 * editor, it is "repeatable rows edited in place with a save bar" — so the
 * same element serves many pages.
 */
