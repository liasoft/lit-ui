 ...
 * banners, modals, the promise-returning confirmation flow, toasts, the
 * diagnostic hint panel and the error boundary.
 *
...
import type { ActionDescriptor, AlertMessage, ToastPlacement, Variant } from '@liasoft/lit-ui';
import {
  LiaElement,
  clearToasts,
...
export const feedbackRoutes: DemoRoute[] = [
  ...
  },
  {
    ...
    description: 'Dialogs, and the promise-returning "are you sure?" flow.',
    keywords: ['modal', 'dialog', 'confirm', 'prompt', 'backdrop'],
    render: renderModals,
  },
  {
